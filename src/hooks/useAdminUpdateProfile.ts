...
export function useAdminUpdateProfile(
  ...
  const [formData, setFormData] = useState<Employee>({
    ...
    document: profileData.document ? { ...profileData.document } : undefined,
    profile: profileData.profile ? { ...profileData.profile } : undefined,
  });
  ...
  const handleSave = async () => {
    try {
      setIsLoading(true);
      await adminUpdateEmployeeProfile(profileData.id, {
        ...formData,
