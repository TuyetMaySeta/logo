...
const EmployeeShareLink = ({ employee }: EmployeeWelcomePageProps) => {
  ...
  // Generate random avatar từ UI Avatars hoặc DiceBear
  const avatarUrl = `https://api.dicebear.com/7.x/avataaars/svg?seed=${employee.full_name}`;

  // Calculate stats từ data thật
  const skillCount = employee.technical_skills?.length || 0;
  const languageCount = employee.languages?.length || 0;
  ...
  useEffect(() => {
    ...
    if (overlay) {
      for (let i = 0; i < 80; i++) {
        ...
        confetti.style.animation = `confettiFall ${Math.random() * 2 + 3}s ease-in-out forwards`;
          ...
          <div className="relative z-10 flex flex-col items-center max-w-4xl px-6">
            ...
            <div className="welcome-name relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-2xl px-10 py-5 shadow-2xl flex justify-center">
                <img
                  src="https://1900.com.vn/storage/uploads/companies/banner/17034/banner-cong-ty-tnhh-seta-international-viet-nam-2206-1746357051.jpg"
            ...
            <div
              ...
              style={{
                animation: "slideUp 0.9s cubic-bezier(0.34, 1.56, 0.64, 1) 1.4s forwards",
              }}
            >
            ...
            <div className="relative">
              ...
              <div className="grid lg:grid-cols-[320px_1fr] gap-8 p-4 lg:p-6 relative z-10 mt-10">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="grid grid-cols-2 gap-3 w-full max-w-[280px] mt-4 mx-auto">
                    {[
                      { value: skillCount, label: "Skills", icon: "🚀" },
                      { value: languageCount, label: "Languages", icon: "🌍" },
                    ].map((stat, idx) => (
                      <div
                        key={idx}
                        className="gradient-border p-3 text-center hover:scale-105 transition-transform duration-300 cursor-pointer"
                      >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 leading-relaxed">
                          ...
                          get to know them and make great things happen together.
                        </p>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="relative flex justify-start gap-7 mb-1 border-b-2 border-gray-200 w-[91%]">
                            ...
                            {tabs.map((tab, index) => (
                              <button
                                ...
                                className={`relative z-10 px-5 py-3 rounded-t-2xl font-bold text-sm whitespace-nowrap transition-colors duration-300 ${
                                  activeTab === tab.id
                                    ? "text-white"
                              ...
                              {activeTab === "work experience" && (
                                <div className="animate-slideIn">
                                  <div className="space-y-6">
                                      ...
                                      {employee.projects && employee.projects.length > 0 && (
                                        <div className="flex-1 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300">
                                          <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                              <p className="text-lg font-bold text-white">Previous Role</p>
                                              <p className="text-base text-blue-50 mt-1">
                                                {employee.projects[0].position}
                                              </p>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    {employee.technical_skills && employee.technical_skills.length > 0 && (
                                        ...
                                        <div className="flex items-start gap-4">
                                          ...
                                          <div className="flex-1">
                                            <div className="flex flex-wrap gap-2">
                                              {employee.technical_skills.map((skill, idx) => (
                                                <span
                                                  key={idx}
...
export default protectedPage(EmployeeShareLink);
