...
import { getMenuSections } from "./menuConfig";
import type { MenuItem } from "../../app/sidebar/menuConfig";
...
export function SidebarNavigationMenu({ project }: SidebarNavigationMenuProps) {
