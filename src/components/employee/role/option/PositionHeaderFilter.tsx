...
export const PositionHeaderFilter = ({
  tableState,
  setTableState,
}: {
  ...
  const columnId = "current_position";
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          className={`h-8 data-[state=open]:bg-accent ${hasActiveFilters ? "bg-accent" : ""
            }`}
        >
          Employee Position {getFilterIcon()}{" "}
      ...
      <PopoverContent className="w-80" align="start">
        <div className="grid gap-4">
          ...
          <div className="space-y-2">
            <h4 className="font-medium leading-none">Employee Position</h4>
            <p className="text-sm text-muted-foreground">
              Sort and filter by employee position
            </p>
          </div>
